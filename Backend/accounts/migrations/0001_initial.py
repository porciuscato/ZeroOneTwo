    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='accounts.Schedule')),
            ],
        ),
        migrations.CreateModel(
            name='Expenditure',
            fields=[
                ...
                ('origin', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='accounts.Receipt')),
